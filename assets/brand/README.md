...
Use this exact file as the brand/logo reference for generated covers and branded props. Do not invent a different mark, use a generic coffee logo, or replace it with post-production subtitle/banner text.
